...
@section('actions')
    ...
    <button type="submit" form="article-update-form"
...
@section('content-inner')
    <form id="article-update-form" class="mt-10" method="POST"
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        ...
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                            <textarea id="content" name="content" rows="3"
                                class="block w-full max-w-2xl rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ $article->content }}</textarea>
